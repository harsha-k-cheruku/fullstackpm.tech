...
- **"2031" Series — 5 parts written, publishing on Substack weekly (Sundays)** — Agent economy, objective drift, value extraction, preference manipulation. Character: Kai. All 5 parts drafted. Part 1 live, Parts 2-5 queued. Archive on fullstackpm.tech pending. (see `06_ARTICLE_AGENT_ECONOMY.md`)
...
- **Article: Building Gets Easy. Selling Gets Brutal.** ✓ Published 2026-03-15 — AI collapses building costs → supply explosion → margin compression → platform absorption (diapers.com pattern); Part 3 of trilogy (see `04_ARTICLE_BUILDING_EASY_SELLING_HARD.md`)
